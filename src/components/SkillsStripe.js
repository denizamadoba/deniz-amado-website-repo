...
const SkillsStripe = () => {
    return (
        <div id="skills" className="z-0 w-full flex flex-col p-4 bg-gradient-to-b from-gray-300 to-red-100 text-gray-800 tracking-widest">
            ...
            <div class="flex flex-row w-full space-x-8 my-16 justify-center">
                <div class="pinkShadow flex flex-col bg-white w-96 rounded-lg px-8 pt-12 pb-16 mt-4 text-center">
                ...
                <div class="pinkShadow flex flex-col bg-white w-96 rounded-lg px-8 pt-12 pb-4 mt-4 text-center"> 
